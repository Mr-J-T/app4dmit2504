...
import 'dart:async';
import 'package:app4dmit2504/models/stock_list.dart';
import 'package:app4dmit2504/models/stock.dart';
import 'package:app4dmit2504/services/db-service.dart';
import 'package:app4dmit2504/services/stock_service.dart';
        ...
        children: [
          TextButton(
            ...
            onPressed: () async {
              _stockList.forEach(
                (stock) async {
                  await databaseHelper.deleteDoStock(stock);
                },
              );
              _stockList = await databaseHelper.getAllStocksFromDb();
              await databaseHelper.printAllStocksInDb();
                ...
                onPressed: () async {
                  if (_stockSymbol.isNotEmpty) {
                    ...
                    if (stockData == null) {
                      ...
                      var id = _stockList.length;
                      print('Stock Symbol is $symbol $name $price');
                      await databaseHelper
                          .insertStock(Stock(id, symbol, name, price));
                      _stockList = await databaseHelper.getAllStocksFromDb();
